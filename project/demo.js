...
function WaitingStatus() {
  ...
  reactExports.useEffect(() => {
    ...
    class Reel {
      constructor(canvas, symbols, profile) {
        ...
        this.brake = profile.brake;
        this.extraSpins = profile.extra;
        this.stopDuration = profile.stopDuration;
        this.offset = 0;
        this.speed = 0;
        this.active = false;
        this.stopping = false;
      ...
      draw() {
        const ctx = this.ctx, w = this.c.width, h = this.c.height, t = this.tileH;
    ...
    const profiles = [
      ...
      { max: 2500, accel: 5200, brake: 2e3, extra: 4, stopDuration: 1.6 }
    ];
    ...
    function loop(t) {
      if (!last) last = t;
      const dt = Math.min((t - last) / 1e3, 1 / 30);
      last = t;
      reels.forEach((r) => {
        r.update(dt);
        r.draw();
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { ref: rootRef, children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "slot", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "cabinet", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "reels", id: "reels", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "reel", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("canvas", { width: "164", height: "164" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "winline" })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "reel", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("canvas", { width: "164", height: "164" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "winline" })
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("button", { id: "btn", children: "PLAY (while waiting)" })
    ] }),
...
function App() {
  ...
  const effectiveMax = typeof rawMax === "number" ? Math.max(0, rawMax - 40) : 480;
  ...
  const containerHeight = displayMode === "fullscreen" ? effectiveMax : baseHeight;
  const containerMinHeightClass = isMobile ? "min-h-[360px]" : "min-h-[480px]";
  const externalUrl = toolData?.external_url;
  const pictureUrl = isMobile ? toolData?.mobile_picture_url : toolData?.picture_url;
  const pictureDimensionsClass = isMobile ? "w-[480px] h-[360px]" : "w-[640px] h-[480px]";
  const watchButtonVisible = Boolean(externalUrl);
  const watchButtonClass = "absolute bottom-4 right-6 px-5 py-3 rounded-full bg-green-600 text-white shadow-lg transition-transform duration-300 hover:scale-105 hover:bg-green-700 focus:outline-none focus:ring focus:ring-green-500/50 animate-pulse";
  const noContentIcon = "data:image/svg+xml;base64,";
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(
    "div",
    {
      ...
      className: "relative antialiased w-full overflow-hidden " + containerMinHeightClass + " " + (displayMode === "fullscreen" ? "rounded-none border-0" : "border border-black/10 dark:border-white/10 rounded-2xl sm:rounded-3xl"),
      children: !toolData ? /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex h-full w-full animate-pulse flex-col items-center justify-center gap-2 text-gray-500", children: /* @__PURE__ */ jsxRuntimeExports.jsx(WaitingStatus, {}) }) : !pictureUrl || pictureUrl == "" ? /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex h-full w-full flex-col items-center justify-center gap-4 text-gray-600 dark:text-gray-300", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("img", { src: noContentIcon, alt: "No content", className: "h-20 w-20" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-lg font-semibold", children: "No content found" })
      ] }) : (
        /* Display content */
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex h-full w-full flex-col items-left justify-left p-4", children: [
          pictureUrl ? /* @__PURE__ */ jsxRuntimeExports.jsx(
            "img",
            {
              src: pictureUrl,
              alt: "Preview",
          ...
          ) : /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex h-full w-full items-center justify-center text-gray-500", children: "Image unavailable" }),
          watchButtonVisible && /* @__PURE__ */ jsxRuntimeExports.jsx(
            "button",
            {
              type: "button",
...
clientExports.createRoot(document.getElementById("chatgpt-app-root")).render(/* @__PURE__ */ jsxRuntimeExports.jsx(App, {}));
const index = App ?? App;
export {
  App,
  index as default
